...
void RenderScene() //Zeichenfunktion
{
	...
	gluLookAt(0., 0., 1.5, 0., 0., 0., 0., 1., 0.);//Von vorne, also normal
	//gluLookAt(1., 0., 0., 0., 0., 0., 0., 1., 0.);//von der rechten seite
	//gluLookAt(0., 1., 0., 0., 0., 0., 1., 0., 0.);//von oben
	//gluLookAt(-1., 0., 0., 0., 0., 0., 0., 1., 0.);//von links seite
	//gluLookAt(0., 0., -1., 0., 0., 0., 0., 1., 0.);//von hinten
	...
	//glTranslatef(0.1, 0.1, 0); //sodass es sich nicht im Zentrum des wuerfels dreht
	glRotatef(fRotation, 0., 0., -1.); //-1 wegen den farben wie auf abbildung 4
